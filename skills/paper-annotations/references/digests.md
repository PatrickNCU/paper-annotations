...
Language section: Traditional Chinese prose with each term in the one form the
field actually uses, abbreviations spelled out in full the first time — a digest is read on
